  ...
  return (
    <section className="hero-section relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        {/* Hexagon pattern */}
        <div
          className="absolute top-20 left-20 w-32 h-32 border border-[#E8B4C8]/20 rotate-12 animate-spin"
          style={{
            clipPath:
        ...
        />
        <div
          className="absolute top-40 right-32 w-24 h-24 border border-[#FF6B9D]/30 -rotate-45 animate-spin"
          style={{
            clipPath:
              "polygon(30% 0%, 70% 0%, 100% 50%, 70% 100%, 30% 100%, 0% 50%)",
        ...
        {/* Triangles */}
        <div
          className="absolute top-60 left-1/4 w-16 h-16 border-2 border-[#00D9FF]/25 rotate-45 animate-pulse"
          style={{ clipPath: "polygon(50% 0%, 0% 100%, 100% 100%)" }}
        />
        <div
          className="absolute bottom-40 right-1/4 w-20 h-20 border border-[#E8B4C8]/20 -rotate-12 animate-bounce"
          style={{
        ...
        <div
          className="absolute top-32 right-20 w-40 h-40 rounded-full border border-[#FF6B9D]/30 animate-ping"
        ...
        <div
          className="absolute bottom-1/3 right-10 w-40 h-0.5 bg-gradient-to-r from-transparent via-[#FF6B9D]/30 to-transparent -rotate-12 animate-pulse"
          style={{ animationDelay: "1s" }}
        />

        {/* Dots pattern */}
        <div
          className="absolute top-1/4 left-1/3 w-2 h-2 bg-[#E8B4C8] rounded-full animate-ping"
          style={{ animationDelay: "0.5s" }}
        />
        <div
          className="absolute top-1/2 right-1/3 w-1.5 h-1.5 bg-[#FF6B9D] rounded-full animate-ping"
          style={{ animationDelay: "1.5s" }}
        />
        <div
          className="absolute bottom-1/3 left-1/4 w-3 h-3 bg-[#00D9FF] rounded-full animate-ping"
          style={{ animationDelay: "2s" }}
        />
        <div
          className="absolute top-3/4 right-1/4 w-1 h-1 bg-[#E8B4C8] rounded-full animate-ping"
        ...
        {/* Animated squares */}
        <div
          className="absolute top-1/4 right-1/4 w-8 h-8 border border-[#E8B4C8]/30 rotate-45 animate-spin"
          style={{ animationDuration: "8s" }}
        />
        <div
          className="absolute bottom-1/4 left-1/3 w-6 h-6 border border-[#FF6B9D]/25 rotate-12 animate-spin"
        ...
        <div
          className="absolute bottom-1/2 right-1/2 w-0.5 h-0.5 bg-[#FF6B9D] rounded-full shadow-md shadow-[#FF6B9D]/60 animate-pulse"
          style={{ animationDelay: "1s" }}
        />
        <div
          className="absolute top-2/3 left-1/4 w-1.5 h-1.5 bg-[#00D9FF] rounded-full shadow-lg shadow-[#00D9FF]/40 animate-pulse"
          style={{ animationDelay: "0.5s" }}
        />
      </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="inline-block mb-6">
            <div className="px-6 py-3 rounded-full border border-[#E8B4C8]/30 bg-[#E8B4C8]/10">
              <p className="text-[#E8B4C8] text-sm font-medium tracking-wide">
                👋 Hello, I'm
              </p>
            </div>
          </div>
